...
{
	public class REGTaxRateEntryBusiness : IREGTaxRateEntryBusiness, IDataContract<REGTaxRateEntryModel>
	{
		private readonly REGTaxRateEntryRepository dal = new REGTaxRateEntryRepository();
		...
		public OperationResult InsertOrUpdate(MContext ctx, REGTaxRateEntryModel modelData, string fields = null)
		{
			return dal.InsertOrUpdate(ctx, modelData, fields);
		}

		public OperationResult InsertOrUpdateModels(MContext ctx, List<REGTaxRateEntryModel> modelData, string fields = null)
		{
		...
		public REGTaxRateEntryModel GetDataModel(MContext ctx, string pkID, bool includeDelete = false)
		{
			return dal.GetDataModel(ctx, pkID, includeDelete);
		}

		public REGTaxRateEntryModel GetDataModelByFilter(MContext ctx, SqlWhere filter)
		{
			return dal.GetDataModelByFilter(ctx, filter);
		}

		public List<REGTaxRateEntryModel> GetModelList(MContext ctx, SqlWhere filter, bool includeDelete = false)
		{
			return dal.GetModelList(ctx, filter, includeDelete);
		}

		public DataGridJson<REGTaxRateEntryModel> GetModelPageList(MContext ctx, SqlWhere filter, bool includeDelete = false)
		{
