...
{
	public class AchieveLetter
	{
		private static int[] getValue = new int[396]
		{
			-20319,
			-20317,
			-20304,
		...
		private static string[] getName = new string[396]
		{
			"A",
			"Ai",
			"An",
		...
		public static string StrConvertToPinyin(string Chstr)
		{
			...
			for (int j = 0; j < mChar.Length; j++)
			{
				...
				{
					arr2 = Encoding.Default.GetBytes(mChar[j].ToString());
					M5 = arr2[0];
					M4 = arr2[1];
					asc2 = M5 * 256 + M4 - 65536;
					if (asc2 > 0 && asc2 < 160)
					{
