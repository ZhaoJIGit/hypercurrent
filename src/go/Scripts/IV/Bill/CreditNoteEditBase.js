...
var CreditNoteEditBase = {
    ...
    EditUrl: "/IV/Bill/CreditNoteEdit",
    ViewUrl: "/IV/Bill/CreditNoteView",
    IsInit: false,
    IsEdit: true,
    IsFirstLoad: false,
    //初始化
    ...
    emailInvoice: function () {
        IVEditBase.emailInvoice(CreditNoteEditBase.InvoiceID, CreditNoteEditBase.InvoiceType, CreditNoteEditBase.CurrentStatus);
    },
    viewHistory: function () {
        IVEditBase.OpenHistoryDialog(CreditNoteEditBase.InvoiceID, "History", "Invoice_Purchase_Red");
    },
    ...
    saveModel: function (status, callback) {
        ...
        obj.MType = IVBase.InvoiceType.InvoicePurchaseRed;
        obj.MStatus = status;
        obj.MReference = ref;
