var UserEdit = {
    ...
    getPositionRole: function (position, role) {
        ...
        switch (pr) {
            //销售
            case "Sales_Basic":
                return "Sales_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Sale_Reports_MView, Sales_Fapiao_MView";
            case "Sales_DataEntry":
                return "Sales_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Sales_MChange, Expense_Claims_MChange, Contacts_MChange, Attachment_MChange, Sales_Fapiao_MView, Sales_Fapiao_MChange";
            case "Sales_Standard":
                return "Sales_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Sales_MChange, Expense_Claims_MChange, Contacts_MChange, Attachment_MChange, Sales_MApprove, Expense_Claims_MApprove, Contacts_MApprove, Attachment_MApprove, Sale_Reports_MView, \
                Sales_Fapiao_MView, Sales_Fapiao_MChange, Sales_Fapiao_MApprove";
            case "Sales_Advance":
                return "Sales_MView, Sales_MChange, Sales_MApprove, Sales_MExport,\
                Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove, Expense_Claims_MExport,\
                ...
                Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport,\
                Sale_Reports_MView, Sale_Reports_MChange, Sale_Reports_MApprove, Sale_Reports_MExport,\
            ...
            case "SysManage_Admin":
                ...
                Sales_MView, Sales_MChange, Sales_MApprove, Sales_MExport,\
                Purchases_MView, Purchases_MChange, Purchases_MApprove, Purchases_MExport,\
                Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove, Expense_Claims_MExport,\
                Contacts_MView, Contacts_MChange, Contacts_MApprove, Contacts_MExport,\
                Attachment_MView, Attachment_MChange, Attachment_MApprove, Attachment_MExport,\
                Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport,\
                ...
                Sale_Reports_MView, Sale_Reports_MChange, Sale_Reports_MApprove, Sale_Reports_MExport,\
                Purchase_Reports_MView, Purchase_Reports_MChange, Purchase_Reports_MApprove, Purchase_Reports_MExport,\
                Bank_Reports_MView, Bank_Reports_MChange, Bank_Reports_MApprove, Bank_Reports_MExport,\
                PayRun_Reports_MView, PayRun_Reports_MChange, PayRun_Reports_MApprove, PayRun_Reports_MExport,\
                Financial_Reports_MView, Financial_Reports_MChange, Financial_Reports_MApprove, Financial_Reports_MExport,\
                Other_Reports_MView, Other_Reports_MChange, Other_Reports_MApprove, Other_Reports_MExport,\
                Expense_Reports_MView, Expense_Reports_MChange, Expense_Reports_MApprove, Expense_Reports_MExport,\
                ...
                Migration_Tool_Download_MExport,\
                Fixed_Assets_MView,Fixed_Assets_MChange,Fixed_Assets_MApprove,Fixed_Assets_MExport,\
                Fixed_Assets_Reports_MView,Fixed_Assets_Reports_MChange,Fixed_Assets_Reports_MApprove,Fixed_Assets_Reports_MExport";
                //采购
            case "Purchase_Basic":
                return "Purchases_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Purchase_Reports_MView, Purchases_Fapiao_MView";
            case "Purchase_DataEntry":
                return "Purchases_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Purchases_MChange, Expense_Claims_MChange, Contacts_MChange, Attachment_MChange, Purchases_Fapiao_MView, Purchases_Fapiao_MChange";
            case "Purchase_Standard":
                return "Purchases_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Purchases_MChange, Expense_Claims_MChange, Contacts_MChange, Attachment_MChange, Purchases_MApprove, Expense_Claims_MApprove, Contacts_MApprove, Attachment_MApprove, Purchase_Reports_MView,\
                Purchases_Fapiao_MView, Purchases_Fapiao_MChange, Purchases_Fapiao_MApprove";
            case "Purchase_Advance":
                return "Purchases_MView, Purchases_MChange, Purchases_MApprove, Purchases_MExport,\
                Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove, Expense_Claims_MExport,\
                Contacts_MView, Contacts_MChange, Contacts_MApprove, Contacts_MExport,\
                Attachment_MView, Attachment_MChange, Attachment_MApprove, Attachment_MExport,\
                Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport,\
                ...
                //财务
            case "Finance_Basic":
                return "Bank_ExceptReconciliation_MView, Sales_MView, Purchases_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, General_Ledger_MView, Reports_MView, Sale_Reports_MView, Purchase_Reports_MView, Bank_Reports_MView, PayRun_Reports_MView, Financial_Reports_MView, Other_Reports_MView, Expense_Reports_MView, Fapiao_MView, Sales_Fapiao_MView, Purchases_Fapiao_MView,\
                Fixed_Assets_MView,\
                Fixed_Assets_Reports_MView";
            case "Finance_DataEntry":
                ...
                Sales_MView, Sales_MChange,\
                Purchases_MView, Purchases_MChange,\
                Expense_Claims_MView, Expense_Claims_MChange,\
                ...
                Fapiao_MView, Fapiao_MChange,\
                Sale_Reports_MView, Sale_Reports_MChange,\
                Purchase_Reports_MView, Purchase_Reports_MChange,\
                Bank_Reports_MView, Bank_Reports_MChange,\
                PayRun_Reports_MView, PayRun_Reports_MChange,\
                Financial_Reports_MView, Financial_Reports_MChange,\
                Other_Reports_MView, Other_Reports_MChange,\
                Expense_Reports_MView, Expense_Reports_MChange,\
            ...
            case "All_Advance":
                ...
                //人事
            case "HR_Basic":
                return "Expense_Claims_MView, Contacts_MView, Attachment_MView, Payroll_Admin_MView";
            case "HR_DataEntry":
                return "Expense_Claims_MView, Expense_Claims_MChange, Contacts_MView, Attachment_MView, Contacts_MChange, Attachment_MChange, Payroll_Admin_MView, Payroll_Admin_MChange";
            case "HR_Standard":
            case "HR_Advance":
                return "Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove, Contacts_MView, Attachment_MView, Contacts_MChange, Attachment_MChange, Contacts_MApprove, Attachment_MApprove, Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport";
                //其他
            case "Other_Basic":
                return "Expense_Claims_MView, Contacts_MView, Attachment_MView";
            case "Other_DataEntry":
                return "Expense_Claims_MView, Expense_Claims_MChange, Contacts_MView, Attachment_MView, Contacts_MChange, Attachment_MChange";
            case "Other_Standard":
                return "Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove, Contacts_MView, Attachment_MView, Contacts_MChange, Contacts_MApprove, Attachment_MChange";
            case "Other_Advance":
                return "Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove,Expense_Claims_MExport,Contacts_MView, Attachment_MView, Contacts_MChange, Contacts_MApprove,Contacts_MExport, Attachment_MChange";
                //所有岗位
            case "All_Basic":
                return "Bank_MView, Bank_Reconciliation_MView, Bank_ExceptReconciliation_MView, Sales_MView, Purchases_MView, Expense_Claims_MView, Contacts_MView, Attachment_MView, Payroll_Admin_MView, General_Ledger_MView, Reports_MView, Sale_Reports_MView, Purchase_Reports_MView, Bank_Reports_MView, PayRun_Reports_MView, Other_Reports_MView, Expense_Reports_MView, Edit_Settings_MView, Fapiao_MView, Sales_Fapiao_MView, Purchases_Fapiao_MView,Fixed_Assets_MView, Fixed_Assets_Reports_MView";
            case "All_DataEntry":
                return "Bank_MView, Bank_MChange,\
                Bank_Reconciliation_MView, Bank_Reconciliation_MChange,\
                Bank_ExceptReconciliation_MView, Bank_ExceptReconciliation_MChange,\
                ...
                Contacts_MView, Contacts_MChange,\
                Attachment_MView, Attachment_MChange,\
                Payroll_Admin_MView, Payroll_Admin_MChange,\
                General_Ledger_MView, General_Ledger_MChange,\
                Fapiao_MView, Fapiao_MChange,\
                Sales_Fapiao_MView, Sales_Fapiao_MChange,\
                Purchases_Fapiao_MView, Purchases_Fapiao_MChange,\
            ...
            case "All_Standard":
                ...
                Sales_MView, Sales_MChange, Sales_MApprove,\
                Purchases_MView, Purchases_MChange, Purchases_MApprove,\
                Expense_Claims_MView, Expense_Claims_MChange, Expense_Claims_MApprove,\
                Contacts_MView, Contacts_MChange, Contacts_MApprove,\
                Attachment_MView, Attachment_MChange, Attachment_MApprove,\
                Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove,\
                General_Ledger_MView, General_Ledger_MChange, General_Ledger_MApprove,\
                Fapiao_MView, Fapiao_MChange, Fapiao_MApprove,\
                Sales_Fapiao_MView, Sales_Fapiao_MChange, Sales_Fapiao_MApprove,\
                Purchases_Fapiao_MView, Purchases_Fapiao_MChange, Purchases_Fapiao_MApprove,\
                Reports_MView, Reports_MChange, Reports_MApprove,\
                Sale_Reports_MView, Sale_Reports_MChange, Sale_Reports_MApprove,\
                Purchase_Reports_MView, Purchase_Reports_MChange, Purchase_Reports_MApprove,\
                Bank_Reports_MView, Bank_Reports_MChange, Bank_Reports_MApprove,\
                PayRun_Reports_MView, PayRun_Reports_MChange, PayRun_Reports_MApprove,\
                Other_Reports_MView, Other_Reports_MChange, Other_Reports_MApprove,\
                Expense_Reports_MView, Expense_Reports_MChange, Expense_Reports_MApprove,\
                Edit_Settings_MView, Edit_Settings_MChange, Edit_Settings_MApprove,\
                Fixed_Assets_MView,Fixed_Assets_MChange,Fixed_Assets_MApprove,\
                Fixed_Assets_Reports_MView,Fixed_Assets_Reports_MChange,Fixed_Assets_MApprove";
            default:
                break;
        }
    },
    updateIsSelfStatu: function (disable) {
        if (disable) {
            $("#cbxIsSelf").attr("checked", false);
            $("#cbxIsSelf").attr("disabled", "disabled");
        } else {
            $("#cbxIsSelf").removeAttr("disabled");
        }
    },
    //显示用户权限列表
    showUserRole: function () {
        ...
        $("#ddlPosition").combotree({
            data: [
                { id: "Sales", text: HtmlLang.Write(LangModule.User, "Sales", "Sales") },
                { id: "Purchase", text: HtmlLang.Write(LangModule.User, "Purchase", "Purchase") },
                { id: "Finance", text: HtmlLang.Write(LangModule.User, "Finance", "Finance") },
                { id: "HR", text: HtmlLang.Write(LangModule.User, "HR", "HR") },
            ...
            onChange: function (record) {
                ...
                //如果岗位 是人事，则角色默认为：标准用户角色
                if (position_strs == "HR") {
                    if (UserEdit.IsStrikePosition) {
                        $("#ddlRole").combobox("setValue", "Standard");
                    }
                }
                var role = $("#ddlRole").combobox("getValue");
                //如果是管理员，将是否只看自己数据禁用
                UserEdit.updateIsSelfStatu(position_strs.indexOf("SysManage") >= 0 || role == "Basic");
        ...
        $("#ddlRole").combobox({
            ...
            onSelect: function (record) {
                ...
                var role = record.id;
                UserEdit.updateIsSelfStatu(role == "Basic" || role == "Admin");
                UserEdit.loadUserRoleList();
            },
            onBeforeLoad: function () {
                //禁用验证
    ...
    loadUserRoleList: function () {
        ...
        //销售，采购，高级用户
        if (position_strs.indexOf("Sales") > -1 || position_strs.indexOf("Purchase") > -1) {
            if (role == "Advance") {
                //取消指定复选框的选中（工资系统管理 不选中）
                UserEdit.cancelSelect("Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport");
                //解锁指定的复选框（工资系统管理 不锁定）
                UserEdit.deblocking("Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport");
            }
        }
        //采购，财务，标准用户
        if (position_strs.indexOf("Purchase") > -1 || position_strs.indexOf("Finance") > -1) {
            if (role == "Standard") {
                //取消指定复选框的选中（工资系统管理 不选中）
                UserEdit.cancelSelect("Payroll_Admin_MView, Payroll_Admin_MChange, Payroll_Admin_MApprove, Payroll_Admin_MExport");
            }
        ...
        if ($("#cbxIsSelf").attr("checked") == "checked") {
            var lockPermision = "Bank_MView, Bank_MChange, Bank_MApprove, Bank_MExport,\
                Bank_Reconciliation_MView, Bank_Reconciliation_MChange, Bank_Reconciliation_MApprove, Bank_Reconciliation_MExport,\
                Bank_ExceptReconciliation_MView, Bank_ExceptReconciliation_MChange, Bank_ExceptReconciliation_MApprove, Bank_ExceptReconciliation_MExport,\
                Reports_MView, Reports_MChange, Reports_MApprove, Reports_MExport,\
                Sale_Reports_MView, Sale_Reports_MChange, Sale_Reports_MApprove, Sale_Reports_MExport,\
                ...
                Other_Reports_MView, Other_Reports_MChange, Other_Reports_MApprove, Other_Reports_MExport,\
                Expense_Reports_MView, Expense_Reports_MChange, Expense_Reports_MApprove, Expense_Reports_MExport"
            UserEdit.cancelSelect(lockPermision);
            UserEdit.lockRole(lockPermision);
        }
        //禁用Excel Plus下载权限项
    ...
    getGroups: function () {
        ...
        groups.push(UserEdit.getGroup("Sales"));//销售
        groups.push(UserEdit.getGroup("Purchases"));//采购
        groups.push(UserEdit.getGroup("Expense_Claims"));//费用报销
        ...
        groups.push(UserEdit.getGroup("Payroll_Admin"));//工资系统管理
        ...
        groups.push(UserEdit.getGroup("Sale_Reports"));//销售报表
        groups.push(UserEdit.getGroup("Purchase_Reports"));//采购报表
        groups.push(UserEdit.getGroup("Bank_Reports"));//银行报表
        groups.push(UserEdit.getGroup("PayRun_Reports"));//工资类报表
        groups.push(UserEdit.getGroup("Expense_Reports"));//费用报销报表
        groups.push(UserEdit.getGroup("Financial_Reports"));//财务报表
        groups.push(UserEdit.getGroup("Fixed_Assets_Reports"));//固定资产报表
        groups.push(UserEdit.getGroup("Other_Reports"));//一般报表
    ...
    linkageReports: function (id, ckd, role) {
        if (id == "Reports_" + role) {
            $("#Sale_Reports_" + role).attr("checked", ckd);
            $("#Purchase_Reports_" + role).attr("checked", ckd);
            $("#Bank_Reports_" + role).attr("checked", ckd);
            $("#PayRun_Reports_" + role).attr("checked", ckd);
            $("#Other_Reports_" + role).attr("checked", ckd);
            $("#Expense_Reports_" + role).attr("checked", ckd);
            $("#Financial_Reports_" + role).attr("checked", ckd);
            $("#Fixed_Assets_Reports_" + role).attr("checked", ckd);
        }
        if (id == "Sale_Reports_" + role || id == "Purchase_Reports_" + role || id == "Bank_Reports_" + role || id == "PayRun_Reports_" + role
            || id == "Other_Reports_" + role || id == "Expense_Reports_" + role || id == "Financial_Reports_" + role || id == "Fixed_Assets_Reports_" + role) {
            var srv = $("#Sale_Reports_" + role).attr("checked") == undefined ? false : true;
            var prv = $("#Purchase_Reports_" + role).attr("checked") == undefined ? false : true;
            var brv = $("#Bank_Reports_" + role).attr("checked") == undefined ? false : true;
            var prrv = $("#PayRun_Reports_" + role).attr("checked") == undefined ? false : true;
            var orv = $("#Other_Reports_" + role).attr("checked") == undefined ? false : true;
            var erv = $("#Expense_Reports_" + role).attr("checked") == undefined ? false : true;
            //var fr = $("#Financial_Reports_" + role).attr("checked") == undefined ? false : true;
            var fa = $("#Fixed_Assets_Reports_" + role).length > 0 && $("#Fixed_Assets_Reports_" + role).attr("checked") == undefined ? false : true;
            if (srv && prv && brv && prrv && orv && erv && fa) {
        ...
        $("#aInvite").click(function () {
            ...
            $("#DivUserEdit").mFormSubmit({
                url: "/BD/User/UserPermissionUpd", param: { model: { MGrpOperateList: groups } }, callback: function (data) {
                    if (data.Success) {
                        //打开发送邀请对话框
                        UserEdit.openSendInviteDialog(itemId,true);
                    } else {
            ...
            url: "/BD/User/UserPermissionUpd", param: { model: { MGrpOperateList: groups } }, callback: function (data) {
                if (data.Success) {
                    ...
                    if (!userId && data.ObjectID) {
                        ...
                        UserEdit.openSendInviteDialog(data.ObjectID,false);
                    } else {
                        //保存成功，提示信息
    ...
    //打开发送邀请对话框
    openSendInviteDialog: function (itemId, isResent) {
        Megi.dialog({
            title: HtmlLang.Write(LangModule.User, "ResendInvite", "Resend Invite"),
            top: window.pageYOffset || document.documentElement.scrollTop,
            width: 570,
            height: 350,
            href: "/BD/User/UserInvite?id=" + itemId + "&isResent=" + isResent,
        });
    },
    //加载用户权限列表(点击修改进来的)
        ...
        $("body").mFormGet({
            url: "/BD/User/GetUserEditInfo", fill: true, callback: function (data) {
                if (data && data.MItemID != null) {
                    ...
                    UserEdit.updateIsSelfStatu(data.MPosition.indexOf("SysManage") >= 0 || data.MRole == "Basic");
