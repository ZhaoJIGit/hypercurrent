...
namespace JieNor.Megi.DataRepository.SEC
{
	public class SECSendLinkInfoRepository : DataServiceT<SECSendLinkInfoModel>
	{
		...
		public static void InsertLink(string itemid, string email, DateTime time, string phone, string firstName, string lastName, int linkType, string invitationEmail, string invitationOrgID)
		{
			StringBuilder stringBuilder = new StringBuilder();
