(function ($) {
		...
		dc.body1.add(dc.body2).unbind().bind("mouseover", function (e) {
			...
			if (tt.parent().hasClass("datagrid-cell-check")) {
				...
				if (opts.singleSelect == true) {
					...
					} else { if (tr.hasClass("datagrid-row-selected")) {
							_5d3(_55a, _567);
						} else {
							_5cb(_55a, _567);
						}
	...
	function _5c0(_5c1, _5c2) {
		...
		if (tr.length) {
			...
			} else { if (top + tr._outerHeight() > _5c5.height() - 18) {
	...
	function _61d(_61e, _61f) {
		...
		if (!_61f) {
			...
			return rows;
		} else { if (_61f == "inserted") {
				return _620;
			} else { if (_61f == "deleted") {
					return _621;
				} else { if (_61f == "updated") {
						return _622;
					}
				}
			}
