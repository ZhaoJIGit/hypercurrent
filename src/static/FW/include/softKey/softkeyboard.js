...
document.write('<div align="center" id="softkeyboard" name="softkeyboard" style="position: absolute; left: 0px; top: 0px; width: 400px; z-index: 180; display: block;"><table id="CalcTable" width="" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="" style="border: 1px solid rgb(181, 173, 241);"><form id="Calc" name="Calc" action="" method="post" autocomplete="off"></form><tbody><tr><td class="table_title" align="right" valign="middle" bgcolor="" style="cursor: default;height:30"><input type="hidden" value="" name="password"><input type="hidden" value="ok" name="action2">&nbsp;<font style="font-weight:bold; font-size:13px; color:#075BC3">博客园&nbsp;&nbsp;密码输入器</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="useKey" class="btn_input" type="button" value="使用键盘输入" bgtype="1" onclick="password1.readOnly=0;password1.focus();closekeyboard();password1.value='';"><span style="width:2px;"></span></td></tr><tr align="center"><td align="center" bgcolor="#FFFFFF"><table align="center" width="%" border="0" cellspacing="1" cellpadding="0">''
 + '<tbody><tr align="left" valign="middle"> '
    ...
    + '<td><input type="button" value=" ` "></td>'
    + '<td><input type="button" bgtype="2" name="button_number1" value=" 0 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number2" value=" 2 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number3" value=" 3 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number4" value=" 9 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number5" value=" 4 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number6" value=" 6 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number7" value=" 5 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number8" value=" 7 "></td>'
    + '<td> <input type="button" bgtype="2" name="button_number9" value=" 8 "></td>'
    + '<td> <input bgtype="2" name="button_number0" type="button" value=" 1 "></td>'
    + '<td> <input type="button" value=" - "></td>'
    + '<td> <input type="button" value=" = "></td>'
    + '<td> <input type="button" value=" \ "></td>'
    + '<td> </td>'
