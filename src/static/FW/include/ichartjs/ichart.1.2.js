...
; (function ($) {
    ...
    $.Component = $.extend($.Painter, {
        configure: function (c) {
            ...
            this.set({
                 ...
                 */
                font: ((top.OrgLang[0].LangID == '0x0009') ? "Arial" : "Microsoft Yahei"),
                /**
    ...
    $.Tip = $.extend($.Html, {
        ...
        text: function (n, v, t, i, j, _) {
            _.dom.innerHTML = _.fireString(_, 'parseText', [_, n, v, t, i, j], t);
        },
        hidden: function (e) {
            if (this.get('animation')) {
                this.css('opacity', 0);
        ...
        initialize: function () {
            ...
            _.text(_.get('name'), _.get('value'), _.get('text'), _.get('index'), _.get('x_index'), _);
            _.hidden();
        ...
        $.Chart = $.extend($.Painter, {
            ...
            doActing: function (_, d, o, i, t) {
                ...
                if (_.get('sub_option.tip.enable')) {
                    ...
                    _.push('sub_option.tip.text', "123123");
                    _.push('sub_option.tip.name', d.name);
                    _.push('sub_option.tip.index', i);
                    if (o) {
                        _.push('sub_option.tip.x_index', o.x_index);
                        _.push('sub_option.tip.y_index', o.y_index);
                    }
